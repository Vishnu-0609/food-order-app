  ...
  return (
    <section className='flex flex-col items-center w-100 h-100 bg-gradient-to-t from-[#f4f3e9] to-white mt-12'>
        <div className='mt-10 flex items-center'>
          ...
          <div className="text-primary xl:text-xl lg:text-lg md:text-lg sm:text-md text-sm">
        ...
        <div className='flex justify-center items-center align-middle'>
            <h1 className='xl:text-5xl lg:text-4xl md:text-3xl sm:text-2xl text-md font-serif text-primary font-black py-10 px-2'>IF YOU CAN DREAM IT WE CAN MAKE IT</h1>
        </div>
        <div>
        ...
        <div className='mt-12 mb-12'>
            <Link href={'menu/PIZZAS'} className='bg-primary uppercase gap-4 text-white px-14 py-3 rounded-full xl:text-lg lg:text-lg md:text-lg sm:text-md text-sm items-center font-[1000] font-sans'>EXPLORE OUR FULL MENU</Link>
        </div>
    </section>
  )
}
