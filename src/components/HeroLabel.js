...
function HeroLabel()
{
  return (
    <section className='relative'>
        <div className='absolute w-full xl:px-10 lg:px-10 md:px-8 sm:px-4 px-2 lg:top-20 md:top-14 top-2'>
          ...
          <div className='xl:h-96 lg:h-72 md:h-44 sm:h-40 h-28'>
            <div className='flex flex-col items-start'>
          ...
          <div className='flex flex-col items-end lg:h-72 xl:h-96 md:h-56 sm:h-60 h-28'>
            <div className='flex flex-col items-start'>
        ...
        <section className='w-full h-full bg-[#da291c] py-4 text-center'>
          ...
          <div className='my-12'>
              <Link href={"/cart"} className='bg-white uppercase gap-4 text-primary px-14 py-3 rounded-full text-xl items-center font-[1000] font-serif'>VIEW CART</Link>
          </div>
        </section>
    </section>
  )
